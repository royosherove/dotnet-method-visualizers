...
namespace ClrTest.Reflection
{
    public abstract class ILInstruction
    {
        ...
        internal static IILFormatProvider s_formatProvider = new DefaultFormatProvider();
        public static void SetFormatProvider(IILFormatProvider formatProvider) { s_formatProvider = formatProvider; }

        public override string ToString() { return s_formatProvider.Format(this); }

        public string ToShortString()
        {
            return this.ToString().Remove(9, 20);
        }
    }
